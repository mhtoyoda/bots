...
@SpringBootTest
public class IcaptorSdkPdfApplicationTests {
	...
	public void contextLoads() {
		String vencimento = new PdfImpl(path,1)
	...
	public void dataEmissao(){
		...
		String dataEmissao = new PdfImpl(path,1)
	...
	public void icms(){
		...
		String icms = new PdfImpl(path,2)
	...
	public void valorPagar(){
		String valorPagar = new PdfImpl(path,1)
	...
	@Test
	public void cnpj(){
		String cnpj = new PdfImpl(path,2)
	...
	public void createPojo() {
		...
		map.put(FromTo("Mês Referência","referencia")," [0-9]{2}/[0-9]{4}");

		PojoTest pojo = (PojoTest) new PdfImpl(path)
				.search(map,PojoTest.class)
				.build();
