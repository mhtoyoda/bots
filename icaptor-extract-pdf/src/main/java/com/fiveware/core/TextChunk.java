...
public class TextChunk extends RectangularTextContainer<TextElement> implements HasText {
    ...
    static {
        ...
        directionalities.put(Character.DIRECTIONALITY_POP_DIRECTIONAL_FORMAT, DirectionalityOptions.NONE);      // Weak BCT    "extract" in the Unicode specification.
    ...
    */
    ...
    public int isLtrDominant() {
        ...
        return Integer.compare(ltrCnt, rtlCnt); // 1 is LTR, 0 is neutral, -1 is RTL
    }
