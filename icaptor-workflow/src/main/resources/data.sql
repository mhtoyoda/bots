...
INSERT INTO Workflow_Bot_Step(id, bot_source, bot_target, sequence, field_verify) VALUES(1, 'votorantimRC', 'consultaSap', 2, '\\"numeroRC\\":\\"(\d+)\\"');
INSERT INTO Workflow_Bot_Step(id, bot_source, bot_target, sequence, field_verify) VALUES(2, 'consultaSap', 'votorantimCP', 3, '\\"aprovadoRC\\":\\"(\true)\\"');
INSERT INTO Workflow_Bot_Step(id, bot_source, bot_target, sequence, field_verify) VALUES(3, 'votorantimCP', 'votorantimCAP', 4, '\\"numeroPC\\":\\"(\d+)\\"');
INSERT INTO Workflow_Bot_Step(id, bot_source, sequence) VALUES(4, 'votorantimCAP', 5);