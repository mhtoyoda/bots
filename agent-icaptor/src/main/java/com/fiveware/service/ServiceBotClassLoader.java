...
public  class ServiceBotClassLoader<T> {
    ...
    private Map executeMainClass(T parameter, Optional<BotClassLoaderContext> botClassLoaderContext) throws MalformedURLException, ClassNotFoundException, ExceptionBot, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
