...
//             acceptedFiles: '.png,.jar',
            drop.init =new function() {
                // myDropzone = this;
                drop.on('success', function( file, resp ){
                    console.log( file );
                    console.log( resp );
                });
            ...
            // drop.accept = new function(file,done) {
            //     // file.acceptDimensions = drop.done;
            //     file.rejectDimensions = new function(done) {
            //         drop.done('The image must be at least 640 x 480px')
            //     };
            // };
